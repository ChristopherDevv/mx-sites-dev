<section id="location" class="flex justify-center">
    <div class="w-full md:w-9/12 flex flex-col md:flex-row justify-center py-16 gap-10">
        ...
        <div class="md:w-1/2">
            <iframe src="{{ config('angy.brand.iframe') }}" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
        ...
        <div class="w-full text-lg py-4 px-4 md:hidden font-normal text-navGray">
            ...
            <p>Phone number: {{ config('angy.brand.cell-phone') }}</p>
            <p>Email: {{ config('angy.brand.email') }}</p>
        </div>
    </div>
</section>
