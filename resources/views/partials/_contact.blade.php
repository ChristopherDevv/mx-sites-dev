        ...
        <div class="flex flex-col w-full gap-8 justify-center items-center md:justify-start md:items-start md:text-left md:w-1/2">
            ...
            <div class="font-semibold md:flex flex-col gap-6 w-full hidden">
                <div class="flex items-center gap-4">
                    ...
                    <a href="mailto:juanbarrios627@gmail.com" class="underline break-all text-secondary">{{ __('brand.email') }}</a>
                </div>
                <div class="flex items-center gap-4">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                    ...
                    <div class="flex flex-col gap-y-2 ">
                        <a href="tel:+14694600925" class="underline text-secondary">{{ __('brand.cell-phone') }}</a>
                    </div>
                </div>
            </div>
        </div>
